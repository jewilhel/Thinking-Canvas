...
Approved scope revision — 2026-09-08 (`PD-001`): deliver AI-only live conversation now. Remote-human voice (`FR-010`) and its transport implementation/testing are explicitly deferred to reduce cost and complexity. Their original wording remains below for traceability and their boxes remain unchecked. Milestone 10 closure covers the remaining active requirements, supporting work, and unchanged Live co-thinking exit gate; it does not claim human-voice delivery. Detailed plan: [Milestone 10 — Live conversation](docs/implementation/milestone-10-live-conversation.md). The owner subsequently approved the documented implementation slices and Netlify background supervisor; final tuning/defaults and milestone acceptance remain pending.
