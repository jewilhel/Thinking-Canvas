...
- [x] **PD-002 — Document preview:** render the first visible page or a bounded continuous-layout window inside the page-like canvas object, with title, layout indicator, and an explicit continuation or overflow cue; pause expensive editing and rendering work outside the viewport. Approved by the product owner with the Milestone 8 plan on 2026-09-02.
