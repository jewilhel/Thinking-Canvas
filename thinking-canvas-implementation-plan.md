...
- [ ] **FR-045 — Page-like board representation.** A document is recognizable as a page-like object at canvas level, retains a compact visible page shadow when closed or focused, and has an approved long-content preview behavior.
