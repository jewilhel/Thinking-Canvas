...
Pending architecture refinement — 2026-09-09: hosted pre-peer sideband attachment returns HTTP 404. The milestone record's proposed D6 feasibility test would start the deadline supervisor first, complete a muted peer handshake, and require sideband attachment within 10 seconds before normal audio/controls. This introduces a bounded pre-attachment interval and needs explicit approval before implementation. The $10 shared daily allowance and original 10-minute session cap remain unchanged; no FR or exit gate is accepted by this proposal.
