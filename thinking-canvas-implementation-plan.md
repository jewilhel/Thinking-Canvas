...
- [ ] **FR-052 — Internal collaboration.** Text ranges and internal objects support comments, replies, structured prompts, annotations, and AI-assisted review. The internal-object portion is superseded by `PD-022`; document text-range collaboration remains active.
