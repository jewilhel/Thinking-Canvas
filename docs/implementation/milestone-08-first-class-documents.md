...
- No database migration was added. A local Supabase reset/policy run, the complete serialized end-to-end suite, protected CI, and Netlify preview verification have not been performed for Milestone 8 yet. Those remain required in their applicable slices and cannot be inferred from the local source/build and focused Chromium gates.
