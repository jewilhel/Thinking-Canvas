...
export function WorkspacePrimaryDock({
  ...
  return (
    <div className="pointer-events-auto absolute right-[22rem] bottom-4 left-4 z-40 lg:right-auto lg:left-[calc(50%-10rem)] lg:max-w-[calc(100%-22rem)] lg:-translate-x-1/2">
      {openPalette ? (
        <div
