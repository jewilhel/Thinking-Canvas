...
- The participant asks a canvas question, requests creating or editing a document, saving a summary/brief/available transcript, creating or replying to a comment, resolving/dismissing/reopening/deleting a comment, undoing the last AI edit, selecting objects, opening or closing documents, or creating, moving, resizing, restyling, relabeling, connecting or removing canvas objects. Delegate the actual question or requested comment; do not substitute a generic description.
